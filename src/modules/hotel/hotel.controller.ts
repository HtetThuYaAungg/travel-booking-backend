...
export class HotelController {
  ...
  async create(@Body() createHotelDto: CreateHotelDto, @Request() req): Promise<Hotel> {
  ...
  @ApiQuery({ name: 'search', required: false, description: 'Search by name, location, or city' })
  ...
  @ApiQuery({ name: 'min_star_rating', required: false, description: 'Minimum star rating' })
  @ApiQuery({ name: 'min_rating', required: false, description: 'Minimum rating' })
  ...
  @ApiQuery({ name: 'has_restaurant', required: false, description: 'Has Restaurant' })
  @ApiQuery({ name: 'has_parking', required: false, description: 'Has Parking' })
  @ApiQuery({ name: 'has_pet_friendly', required: false, description: 'Pet Friendly' })
  ...
  async findAll(@Query() filters: HotelFilterDto): Promise<PaginatedResponse<Hotel>> {
  ...
  @ApiResponse({ status: 200, description: 'Popular hotels retrieved successfully' })
  @ApiQuery({ name: 'limit', required: false, description: 'Number of hotels to return' })
  ...
  @ApiResponse({ status: 200, description: 'Hotels retrieved successfully' })
  @ApiQuery({ name: 'limit', required: false, description: 'Number of hotels to return' })
  async getHotelsByLocation(@Param('city') city: string, @Query('limit') limit?: number) {
  ...
  @ApiResponse({ status: 200, description: 'Hotels retrieved successfully' })
  @ApiQuery({ name: 'amenities', required: true, description: 'Comma-separated list of amenities' })
  @ApiQuery({ name: 'limit', required: false, description: 'Number of hotels to return' })
